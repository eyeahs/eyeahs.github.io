...
@Provides 메소드 또는 주입 가능한 클래스에 [@Singleton](http://docs.oracle.com/javaee/7/api/javax/inject/Singleton.html)을 어노테이트하라. 그래프는 그것의 모든 클라이언트들를 위해 동일한 인스턴스를 사용할 것이다.
