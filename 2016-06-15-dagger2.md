...
위 예제는 그 중 더 전형적인 바인딩(binding)들을 가진 component를 어떻게 생성하는지를 보여준다. 하지만 그래프에 바인딩들을 제공하기 위한 다양한 방법들이 있다. 다음은 의존(dependency)들로 가능하며 잘 정의된 component를 생성하기 위해 사용될 수 있다:
...
* Component 의존들의 Component 공급 (provision) 메소드들
* Component 자신
