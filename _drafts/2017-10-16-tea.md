...
그럼 Elm은 무엇일까? 그리고 The Elm Architecture은 어떤 점이 흥미로울까?

Elm은 Javascript로 컴파일되고 웹 브라우저에서 실행할 수 있는 정적 타입, 순수 함수 프로그래밍 언어이다.

[The Elm Architecture](https://guide.elm-lang.org/architecture/)(TEA)는 여러 주요 개념을 가진, 웹 애플리케이션을 만들기 위한 접근법이다.
